/*kreiran avtomatski so tretiot kontroler -> Doctor -> ApplicationDbContext
i najdolu imat plus dve akcii AddPatient sho trebit da se dopiset*/
...
namespace Lab3A.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        {
            var doctor = db.Doctors.Include("Patients").FirstOrDefault(d => d.Id == doctorId);
