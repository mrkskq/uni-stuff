...
public class Main {
    public static float prosekPred (DLL<Integer> lista, DLLNode<Integer> curr){
        int suma = 0;
        int counter = 0;
    ...
    public static float prosekPosle (DLL<Integer> lista, DLLNode<Integer> curr){
        int suma = 0;
        int counter = 0;
        DLLNode<Integer> tmp = curr.succ;
        while (tmp != null) {
            suma += tmp.element;
            counter++;
            tmp = tmp.succ;
    ...
    public static void main(String[] args) {
        ...
        while (curr.succ != null) {
            if (prosekPred(lista, curr) > prosekPosle(lista, curr)){
                counter++;
            }
            curr = curr.succ;
        }
