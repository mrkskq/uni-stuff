...
public class ListaOdListi {
    ...
    public static long findMagicNumber(DLL<DLL<Integer>> list) {
        //Vashiot kod tuka...
        DLLNode<DLL<Integer>> outside_curr = list.getFirst();
        long proizvod = 1;
        while (outside_curr != null) {
            int sum = 0;
            DLLNode<Integer> inside_curr = outside_curr.element.getFirst();
            while (inside_curr != null) {
                sum += inside_curr.element;
                inside_curr = inside_curr.succ;
            }
            proizvod *= sum;
            sum = 0;
            outside_curr = outside_curr.succ;
        }
        return proizvod;
    }
