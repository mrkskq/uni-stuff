...
public class DeleteSLL {
    ...
    public static void change(SLL<Integer> list, int br) {
        ...
        int counter = 0; //kolku pati se pojavuvat toj broj vo listata
        while (curr != null) {
            if (curr.element == br){
                counter++;
            }
        ...
        if (counter % 2 != 0){ //ako brojot na pojavuvanja e neparen
            curr = list.getFirst();
            while (curr.element != br){ //dojdi kaj prviot najden takov element
                curr = curr.succ;
            }
