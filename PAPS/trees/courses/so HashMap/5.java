...
public class CoursesDrva05 {
    private static int sumaNaStepeniteNaPoddrvoto(BNode<String> node) {
        if (node == null){
            return 0;
        }
        ...
        if (node.left == null || node.right == null){
            return 1 + sumaNaStepeniteNaPoddrvoto(node.left) + sumaNaStepeniteNaPoddrvoto(node.right);
        }
        else{
            return 2 + sumaNaStepeniteNaPoddrvoto(node.left) + sumaNaStepeniteNaPoddrvoto(node.right);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n+q; i++) {
            ...
            if (parts[0].equals("root")){
                ...
                System.out.println(sumaNaStepeniteNaPoddrvoto(node));
            }
        }
    }
}
