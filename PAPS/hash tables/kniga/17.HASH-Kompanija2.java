...
//strana 241 vo knigata (so poinakov output)
...
public class Kompanija {
    public static void main(String[] args) {
        ...
        int n = sc.nextInt();
        sc.nextLine();
        CBHT<String, List<String>> table = new CBHT<>(2*n-1);
        CBHT<String, Integer> table2 = new CBHT<>(2*n-1);
        ...
        for (String menadzer : menadzeri){
            ...
            System.out.print(menadzer + "=" + curr.element.value);
            if (counter < menadzeri.size()){
                System.out.print(", ");
                counter++;
            }
        }
